...
const ChatInterface: React.FC<ChatInterfaceProps> = ({ messages, onSendMessage, isLoading }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-inner">
      <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50 dark:bg-gray-900">
            ...
            >
              ...
              {msg.groundingMetadata?.web && msg.groundingMetadata.web.length > 0 && (
                <div className="mt-3 pt-3 border-t border-gray-100 dark:border-gray-600">
                  <p className="text-xs font-semibold mb-2 text-gray-500 dark:text-gray-400">لینک‌های پیشنهادی:</p>
                  <div className="flex flex-col gap-2">
                    {msg.groundingMetadata.web.map((link, idx) => (
                      <a 
                        ...
                        className="flex items-center text-xs text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 bg-blue-50 dark:bg-blue-900/30 p-2 rounded transition-colors"
                      >
        ...
        {isLoading && (
          <div className="flex justify-start">
            <div className="bg-white dark:bg-gray-700 rounded-2xl px-4 py-3 rounded-bl-none border border-gray-200 dark:border-gray-600 flex items-center">
      ...
      <form onSubmit={handleSubmit} className="p-3 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 flex items-center gap-2">
        <input
          ...
          className="flex-1 bg-gray-100 dark:bg-gray-700 text-right text-gray-900 dark:text-white rounded-full px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50"
          disabled={isLoading}
        />
        <button
          type="submit"
